...
"[project]/node_modules/@vapi-ai/web/dist/api.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ class Api extends HttpClient {
    constructor(...args){
        var _this;
        super(...args), _this = this, _define_property._(this, "call", {
            /**
         * No description
         *
         * @tags Calls
         ...
         * @secure
         */ callControllerExportCalls: function(query) {
                let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return _this.request({
                    path: "/v2/call/export",
                    method: "GET",
         ...
         * @secure
         */ campaignControllerFindAllPaginated: function(query) {
                let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return _this.request({
        ...
        }), _define_property._(this, "support", {
            /**
         * No description
         *
         * @tags Support
         ...
         * @secure
         */ supportControllerCreateTicket: function(data) {
                let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return _this.request({
                    path: "/support/ticket",
                    method: "POST",
        ...
        }), _define_property._(this, "assistant", {
            /**
         * No description
         *
         * @tags Assistants
         ...
         * @secure
         */ workflowControllerGenerateFromTranscripts: function(data) {
                let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return _this.request({
         ...
         * @request GET:/log
         * @secure
         */ loggingControllerCallLogsQuery: function(query) {
                let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return _this.request({
                    path: "/log",
                    method: "GET",
         ...
         * @request DELETE:/log
         * @secure
         */ loggingControllerCallLogsDeleteQuery: function(query) {
                let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return _this.request({
                    path: "/log",
                    method: "DELETE",
         ...
         * @deprecated
         * @secure
         */ loggingControllerLogsQuery: function(query) {
                let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return _this.request({
                    path: "/logs",
                    method: "GET",
         ...
         * @deprecated
         * @secure
         */ loggingControllerLogsDeleteQuery: function(query) {
                let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return _this.request({
                    path: "/logs",
                    method: "DELETE",
         ...
         * @secure
         */ credentialControllerCredentialActionTrigger: function(data) {
                let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return _this.request({
...
"[project]/node_modules/@vapi-ai/web/dist/client.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@vapi-ai/web/dist/vapi.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class Vapi extends VapiEventEmitter {
            ...
            this.call.on('nonfatal-error', (e)=>{
                ...
                if ((e === null || e === void 0 ? void 0 : e.type) === 'audio-processor-error') {
                    ...
                    (_this_call = this.call) === null || _this_call === void 0 ? void 0 : _this_call.updateInputSettings({
                        ...
                        var _this_call;
                        (_this_call = this.call) === null || _this_call === void 0 ? void 0 : _this_call.setLocalAudio(true);
                    });
                }
            });
    ...
    setInputDevicesAsync(options) {
        var _this_call;
        (_this_call = this.call) === null || _this_call === void 0 ? void 0 : _this_call.setInputDevicesAsync(options);
    }
    ...
    constructor(apiToken, apiBaseUrl, dailyCallConfig, dailyCallObject){
        ...
        this.dailyCallConfig = dailyCallConfig !== null && dailyCallConfig !== void 0 ? dailyCallConfig : {};
        this.dailyCallObject = dailyCallObject !== null && dailyCallObject !== void 0 ? dailyCallObject : {};
    }
}
...
//# sourceMappingURL=node_modules_%40vapi-ai_web_dist_98fc99c2._.js.map