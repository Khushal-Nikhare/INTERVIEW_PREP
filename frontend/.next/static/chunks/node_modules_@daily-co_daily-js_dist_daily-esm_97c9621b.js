...
function Jt(e, t) {
    ...
    const a = function(e, t) {
        try {
            ...
            if ("undefined" != ("TURBOPACK compile-time value", "object") && t === ("TURBOPACK ident replacement", globalThis)) return "[Global]";
...
var js = function() {
    function e() {
        var n, r, i, o;
        return t(this, e), r = this, i = a(i = e), n = s(r, As() ? Reflect.construct(i, o || [], a(r).constructor) : i.apply(r, o)), ("TURBOPACK ident replacement", globalThis).callMachineToDailyJsEmitter = ("TURBOPACK ident replacement", globalThis).callMachineToDailyJsEmitter || new y.EventEmitter, ("TURBOPACK ident replacement", globalThis).dailyJsToCallMachineEmitter = ("TURBOPACK ident replacement", globalThis).dailyJsToCallMachineEmitter || new y.EventEmitter, n._wrappedListeners = {}, n._messageCallbacks = {}, n;
    }
    return l(e, Ms), o(e, [
        {
            key: "addListenerForMessagesFromCallMachine",
            value: function(e, t, n) {
                this._addListener(e, ("TURBOPACK ident replacement", globalThis).callMachineToDailyJsEmitter, t, n, "received call machine message");
            }
        },
        {
            key: "addListenerForMessagesFromDailyJs",
            value: function(e, t, n) {
                this._addListener(e, ("TURBOPACK ident replacement", globalThis).dailyJsToCallMachineEmitter, t, n, "received daily-js message");
            }
        },
        {
            key: "sendMessageToCallMachine",
            value: function(e, t, n) {
                this._sendMessage(e, ("TURBOPACK ident replacement", globalThis).dailyJsToCallMachineEmitter, n, t, "sending message to call machine");
            }
        },
        {
            key: "sendMessageToDailyJs",
            value: function(e, t) {
                this._sendMessage(e, ("TURBOPACK ident replacement", globalThis).callMachineToDailyJsEmitter, t, null, "sending message to daily-js");
            }
        },
        {
            key: "removeListener",
            value: function(e) {
                var t = this._wrappedListeners[e];
                t && (("TURBOPACK ident replacement", globalThis).callMachineToDailyJsEmitter.removeListener("message", t), ("TURBOPACK ident replacement", globalThis).dailyJsToCallMachineEmitter.removeListener("message", t), delete this._wrappedListeners[e]);
            }
        },
        {
            key: "_addListener",
